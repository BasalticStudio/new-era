...
# source://brakeman-5.3.1/lib/brakeman/version.rb:1
module Brakeman
  class << self
    # source://brakeman-5.3.1/lib/brakeman.rb:568
    def add_external_checks(options); end

    # source://brakeman-5.3.1/lib/brakeman.rb:574
    ...
    # @raise [ArgumentError]
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:483
    def compare(options); end

    # source://brakeman-5.3.1/lib/brakeman.rb:173
    def config_file(custom_location, app_path); end

    # source://brakeman-5.3.1/lib/brakeman.rb:478
    def debug(message); end

    # source://brakeman-5.3.1/lib/brakeman.rb:584
    def debug=(val); end

    # Default set of options
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:180
    def default_options; end

    # Output configuration to YAML
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:338
    def dump_config(options); end

    # source://brakeman-5.3.1/lib/brakeman.rb:364
    def ensure_latest; end

    # source://brakeman-5.3.1/lib/brakeman.rb:540
    def filter_warnings(tracker, options); end

    # Determine output formats based on options[:output_formats]
    # or options[:output_files]
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:210
    ...
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:530
    def ignore_file_entries_with_empty_notes(file); end

    # Output list of checks (for `-k` option)
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:316
    def list_checks(options); end

    # source://brakeman-5.3.1/lib/brakeman.rb:502
    def load_brakeman_dependency(name, allow_fail = T.unsafe(nil)); end

    # Load options from YAML file
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:124
    def load_options(line_options); end

    # source://brakeman-5.3.1/lib/brakeman.rb:474
    def notify(message); end

    # source://brakeman-5.3.1/lib/brakeman.rb:588
    def quiet=(val); end
    ...
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:463
    ...
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:76
    def run(options); end

    # Run a scan. Generally called from Brakeman.run instead of directly.
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:373
    def scan(options); end

    # Sets up options for run, checks given application path
    #
    # source://brakeman-5.3.1/lib/brakeman.rb:90
    def set_options(options); end

    private

    # source://brakeman-5.3.1/lib/brakeman.rb:263
    def get_formats_from_output_files(output_files); end

    # source://brakeman-5.3.1/lib/brakeman.rb:229
    def get_formats_from_output_format(output_format); end

    # source://brakeman-5.3.1/lib/brakeman.rb:299
    def get_github_url(options); end

    # source://brakeman-5.3.1/lib/brakeman.rb:417
    def write_report_to_files(tracker, output_files); end

    # source://brakeman-5.3.1/lib/brakeman.rb:435
    def write_report_to_formats(tracker, output_formats); end
  end
end

# source://brakeman-5.3.1/lib/brakeman.rb:161
Brakeman::CONFIG_FILES = T.let(T.unsafe(nil), Array)

# source://brakeman-5.3.1/lib/brakeman.rb:592
...
#
# source://brakeman-5.3.1/lib/brakeman.rb:25
