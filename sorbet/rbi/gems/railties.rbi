...
class Rails::Generators::AppBase < Rails::Generators::Base
  ...
  def initialize(positional_argv, option_argv, *arg2); end
  ...
  def sqlite3?; end
  def target_rails_prerelease(self_command = nil); end
  def using_node?; end
...
class Rails::Generators::AppBase::GemfileEntry < Anonymous_Struct_3
  ...
  def self.floats(name, comment = nil); end
...
class Rails::Generators::AppGenerator < Rails::Generators::AppBase
  ...
  def run_css(*arg0); end
  def run_hotwire(*arg0); end
  def run_javascript(*arg0); end
  def self.banner; end
  def set_default_accessors!(*arg0); end
  def target_rails_prerelease(*arg0); end
