...
#
# source://sidekiq-6.5.5/lib/sidekiq/version.rb:3
module Sidekiq
  class << self
...
# source://sidekiq-6.5.5/lib/sidekiq/client.rb:8
class Sidekiq::Client
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/client.rb:44
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/client.rb:23
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/client.rb:72
  def push(item); end
  ...
  # @raise [ArgumentError]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/client.rb:97
  def push_bulk(items); end

  # Returns the value of attribute redis_pool.
  #
  # source://sidekiq-6.5.5/lib/sidekiq/client.rb:32
  def redis_pool; end
  ...
  # source://sidekiq-6.5.5/lib/sidekiq/client.rb:221
  def atomic_push(conn, payloads); end

  # source://sidekiq-6.5.5/lib/sidekiq/client.rb:197
  ...
  class << self
    ...
    #
    # source://sidekiq-6.5.5/lib/sidekiq/client.rb:162
    def enqueue(klass, *args); end

    # Example usage:
    #   Sidekiq::Client.enqueue_in(3.minutes, MyJob, 'foo', 1, :bat => 'bar')
    #
    # source://sidekiq-6.5.5/lib/sidekiq/client.rb:190
    def enqueue_in(interval, klass, *args); end

    # Example usage:
    #   Sidekiq::Client.enqueue_to(:queue_name, MyJob, 'foo', 1, :bat => 'bar')
    #
    # source://sidekiq-6.5.5/lib/sidekiq/client.rb:169
    def enqueue_to(queue, klass, *args); end

    # Example usage:
    #   Sidekiq::Client.enqueue_to_in(:queue_name, 3.minutes, MyJob, 'foo', 1, :bat => 'bar')
    #
    # source://sidekiq-6.5.5/lib/sidekiq/client.rb:176
    def enqueue_to_in(queue, interval, klass, *args); end

    # source://sidekiq-6.5.5/lib/sidekiq/client.rb:146
    def push(item); end

    # source://sidekiq-6.5.5/lib/sidekiq/client.rb:150
    def push_bulk(items); end
    ...
    #
    # source://sidekiq-6.5.5/lib/sidekiq/client.rb:136
    def via(pool); end
  end
end
...
# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:7
module Sidekiq::Context
  class << self
    # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:20
    def add(k, v); end

    # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:16
    def current; end

    # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:8
    def with(hash); end
  end
end
...
# source://sidekiq-6.5.5/lib/sidekiq/delay.rb:4
module Sidekiq::Extensions
  class << self
    # source://sidekiq-6.5.5/lib/sidekiq/delay.rb:5
    def enable_delay!; end
  end
end

# source://sidekiq-6.5.5/lib/sidekiq/delay.rb:28
module Sidekiq::Extensions::PsychAutoload
  # source://sidekiq-6.5.5/lib/sidekiq/delay.rb:29
...
# source://sidekiq-6.5.5/lib/sidekiq/job_util.rb:5
module Sidekiq::JobUtil
  # @raise [ArgumentError]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/job_util.rb:35
  def normalize_item(item); end

  # source://sidekiq-6.5.5/lib/sidekiq/job_util.rb:56
  def normalized_hash(item_class); end

  # @raise [ArgumentError]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/job_util.rb:10
  def validate(item); end

  # source://sidekiq-6.5.5/lib/sidekiq/job_util.rb:18
  ...
  # @return [Boolean]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/job_util.rb:67
  def json_safe?(item); end
end

# These functions encapsulate various job utilities.
#
# source://sidekiq-6.5.5/lib/sidekiq/job_util.rb:8
...
# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:95
class Sidekiq::Logger < ::Logger
  include ::Sidekiq::LoggingUtils

  # @return [Logger] a new instance of Logger
  #
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:98
  def initialize(*args, **kwargs); end
end

# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:103
module Sidekiq::Logger::Formatters; end

# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:104
class Sidekiq::Logger::Formatters::Base < ::Logger::Formatter
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:109
  def ctx; end

  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:113
  def format_context; end

  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:105
  def tid; end
end

# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:139
class Sidekiq::Logger::Formatters::JSON < ::Sidekiq::Logger::Formatters::Base
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:140
  def call(severity, time, program_name, message); end
end

# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:127
class Sidekiq::Logger::Formatters::Pretty < ::Sidekiq::Logger::Formatters::Base
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:128
  def call(severity, time, program_name, message); end
end

# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:133
class Sidekiq::Logger::Formatters::WithoutTimestamp < ::Sidekiq::Logger::Formatters::Pretty
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:134
  def call(severity, time, program_name, message); end
end

# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:25
module Sidekiq::LoggingUtils
  # Redefined to check severity against #level, and thus the thread-local level, rather than +@level+.
  # FIXME: Remove when the minimum Ruby version supports overriding Logger#level.
  #
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:76
  def add(severity, message = T.unsafe(nil), progname = T.unsafe(nil), &block); end

  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:39
  def debug?; end
  ...
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:61
  def level; end

  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:44
  def local_level; end

  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:48
  def local_level=(level); end

  # Change the thread-local level for the duration of the given block.
  #
  # source://sidekiq-6.5.5/lib/sidekiq/logger.rb:66
...
# source://sidekiq-6.5.5/lib/sidekiq/logger.rb:26
...
#   end
#
# source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:79
module Sidekiq::Middleware; end

# source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:80
class Sidekiq::Middleware::Chain
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:98
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:122
  def add(klass, *args); end

  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:165
  def clear; end

  # Iterate through each middleware in the chain
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:93
  def each(&block); end

  # @return [Boolean] if the chain contains no middleware
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:157
  def empty?; end

  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:104
  def entries; end

  # @return [Boolean] if the given class is already in the chain
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:152
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:144
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:135
  ...
  # @api private
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:171
  def invoke(*args); end

  # Identical to {#add} except the middleware is added to the front of the chain.
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:128
  ...
  # @param klass [Class]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:110
  def remove(klass); end

  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:161
  def retrieve; end
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:87
...
# @api private
#
# source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:190
class Sidekiq::Middleware::Entry
  # @api private
  # @return [Entry] a new instance of Entry
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:193
  def initialize(config, klass, *args); end

  # @api private
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:191
  def klass; end

  # @api private
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/chain.rb:199
  def make_new; end
end
...
# source://sidekiq-6.5.5/lib/sidekiq/rails.rb:6
class Sidekiq::Rails < ::Rails::Engine; end

# source://sidekiq-6.5.5/lib/sidekiq/rails.rb:7
class Sidekiq::Rails::Reloader
  # @return [Reloader] a new instance of Reloader
  #
  # source://sidekiq-6.5.5/lib/sidekiq/rails.rb:8
  def initialize(app = T.unsafe(nil)); end

  # source://sidekiq-6.5.5/lib/sidekiq/rails.rb:12
  def call; end

  # source://sidekiq-6.5.5/lib/sidekiq/rails.rb:18
  def inspect; end
end

# source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:8
module Sidekiq::RedisConnection
  class << self
    # Returns the value of attribute adapter.
    #
    # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:65
    def adapter; end

    # RedisConnection.adapter = :redis
    # RedisConnection.adapter = :redis_client
    #
    # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:69
    def adapter=(adapter); end

    # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:83
    def create(options = T.unsafe(nil)); end

    private

    # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:152
    def determine_redis_provider; end

    # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:127
    ...
    # @raise [ArgumentError]
    #
    # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:123
    def verify_sizing(size, concurrency); end
  end
end

# source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:9
class Sidekiq::RedisConnection::RedisAdapter
  # @return [RedisAdapter] a new instance of RedisAdapter
  #
  # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:13
  def initialize(options); end

  # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:18
  def new_client; end

  private

  # source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:38
  def client_opts(options); end
end

# source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:10
Sidekiq::RedisConnection::RedisAdapter::BaseError = Redis::BaseError

# source://sidekiq-6.5.5/lib/sidekiq/redis_connection.rb:11
Sidekiq::RedisConnection::RedisAdapter::CommandError = Redis::CommandError

# Server-side middleware must import this Module in order
# to get access to server resources during `call`.
#
# source://sidekiq-6.5.5/lib/sidekiq/middleware/modules.rb:4
module Sidekiq::ServerMiddleware
  # Returns the value of attribute config.
  #
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/modules.rb:5
  def config; end
  ...
  # source://sidekiq-6.5.5/lib/sidekiq/middleware/modules.rb:10
  def logger; end

  # source://sidekiq-6.5.5/lib/sidekiq/middleware/modules.rb:14
  def redis(&block); end

  # source://sidekiq-6.5.5/lib/sidekiq/middleware/modules.rb:6
  def redis_pool; end
end
...
#
# source://sidekiq-6.5.5/lib/sidekiq.rb:342
class Sidekiq::Shutdown < ::Interrupt; end

# source://sidekiq-6.5.5/lib/sidekiq/transaction_aware_client.rb:7
class Sidekiq::TransactionAwareClient
  # @return [TransactionAwareClient] a new instance of TransactionAwareClient
  #
  # source://sidekiq-6.5.5/lib/sidekiq/transaction_aware_client.rb:8
  def initialize(redis_pool); end

  # source://sidekiq-6.5.5/lib/sidekiq/transaction_aware_client.rb:12
  def push(item); end
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/transaction_aware_client.rb:24
  def push_bulk(items); end
end
...
# are very different.
#
# source://sidekiq-6.5.5/lib/sidekiq/worker.rb:44
module Sidekiq::Worker
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:156
  def jid; end
  ...
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:165
  def logger; end
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:158
    def included(base); end
  end
end

# source://sidekiq-6.5.5/lib/sidekiq/worker.rb:267
module Sidekiq::Worker::ClassMethods
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:360
  def build_client; end

  # @raise [ArgumentError]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:355
  def client_push(item); end

  # @raise [ArgumentError]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:268
  def delay(*args); end

  # @raise [ArgumentError]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:272
  def delay_for(*args); end

  # @raise [ArgumentError]
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:276
  def delay_until(*args); end

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:288
  def perform_async(*args); end

  # +interval+ must be a timestamp, numeric or something that acts
  #   numeric (like an activesupport time interval).
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:324
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:318
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:293
  ...
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:280
  def queue_as(q); end

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:284
  def set(options); end
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:351
...
#
# source://sidekiq-6.5.5/lib/sidekiq/worker.rb:48
module Sidekiq::Worker::Options
  ...
  class << self
    # @private
    #
    # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:49
    def included(base); end
  end
end

# source://sidekiq-6.5.5/lib/sidekiq/worker.rb:56
module Sidekiq::Worker::Options::ClassMethods
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:84
  def get_sidekiq_options; end

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:88
  ...
  # options for a specific job.
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:71
  def sidekiq_options(opts = T.unsafe(nil)); end

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:80
  def sidekiq_retries_exhausted(&block); end

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:76
  def sidekiq_retry_in(&block); end
end

# source://sidekiq-6.5.5/lib/sidekiq/worker.rb:57
...
#
# source://sidekiq-6.5.5/lib/sidekiq/worker.rb:173
class Sidekiq::Worker::Setter
  include ::Sidekiq::JobUtil

  # @return [Setter] a new instance of Setter
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:176
  def initialize(klass, opts); end

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:194
  def perform_async(*args); end

  # +interval+ must be a timestamp, numeric or something that acts
  #   numeric (like an activesupport time interval).
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:250
  def perform_at(interval, *args); end

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:239
  ...
  #
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:204
  def perform_inline(*args); end
  ...
  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:186
  def set(options); end

  private

  # source://sidekiq-6.5.5/lib/sidekiq/worker.rb:257
  def at(interval); end
end
