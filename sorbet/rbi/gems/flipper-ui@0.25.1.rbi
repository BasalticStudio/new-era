...
#
# source://flipper-ui-0.25.1/lib/flipper/ui/action_collection.rb:1
module Flipper
...
# source://flipper-ui-0.25.1/lib/flipper/ui/action_collection.rb:2
module Flipper::UI
  class << self
    # @yield [builder]
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui.rb:21
    def app(flipper = T.unsafe(nil), options = T.unsafe(nil)); end

    # source://flipper-ui-0.25.1/lib/flipper/ui.rb:44
    def configuration; end
    ...
    # @yield [configuration]
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui.rb:40
    def configure; end

    # source://flipper-ui-0.25.1/lib/flipper/ui.rb:17
    def root; end
  end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:10
class Flipper::UI::Action
  extend ::Forwardable

  # @return [Action] a new instance of Action
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:109
  def initialize(flipper, request); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:274
  def bootstrap_css; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:278
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:223
  def breadcrumb(text, href = T.unsafe(nil)); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:266
  def csrf_input_tag; end

  # Public: The instance of the Flipper::DSL the middleware was
  # initialized with.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:101
  def flipper; end
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:153
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:201
  def header(name, value); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:286
  def jquery_js; end
  ...
  # Returns a response.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:175
  def json_response(object); end

  # source://RUBY_ROOT/forwardable.rb:229
  def params(*args, &block); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:282
  def popper_js; end

  # Private
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:257
  def public_path; end
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:184
  def redirect_to(location); end

  # Public: The Rack::Request to provide a response for.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:104
  def request; end

  # Private: Returns the request method converted to an action method.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:262
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:125
  def run; end
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:145
  def run_other_action(action_class); end

  # Internal: The path the app is mounted at.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:247
  def script_name; end
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:193
  def status(code); end

  # @return [Boolean]
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:270
  def valid_request_method?; end

  # Private
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:239
  def view(name); end
  ...
  # Returns a response.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:162
  def view_response(name); end

  # Private
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:229
  def view_with_layout(&block); end

  # Private
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:234
  def view_without_layout(name); end

  # Private
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:252
  def views_path; end

  class << self
    # Private: The path to the public folder.
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:95
    def public_path; end
    ...
    # Returns nothing.
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:65
    def route(regex); end
    ...
    # @return [Boolean]
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:70
    def route_match?(path); end

    # Internal: The regex that matches which routes this action will work for.
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:75
    def route_regex; end
    ...
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:85
    def run(flipper, request); end

    # Private: The path to the views folder.
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:90
    def views_path; end
  end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:205
class Flipper::UI::Action::Breadcrumb
  # @return [Breadcrumb] a new instance of Breadcrumb
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:208
  def initialize(text, href = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:213
  def active?; end

  # Returns the value of attribute href.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:206
  def href; end
...
# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:50
Flipper::UI::Action::CONTENT_SECURITY_POLICY = T.let(T.unsafe(nil), String)

# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:11
module Flipper::UI::Action::FeatureNameFromRoute
  private

  # source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:12
  def feature_name; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:48
Flipper::UI::Action::SCRIPT_SRCS = T.let(T.unsafe(nil), Array)

# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:30
Flipper::UI::Action::SOURCES = T.let(T.unsafe(nil), Hash)

# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:49
Flipper::UI::Action::STYLE_SRCS = T.let(T.unsafe(nil), Array)

# source://flipper-ui-0.25.1/lib/flipper/ui/action.rb:23
...
#
# source://flipper-ui-0.25.1/lib/flipper/ui/action_collection.rb:4
class Flipper::UI::ActionCollection
  # @return [ActionCollection] a new instance of ActionCollection
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/action_collection.rb:5
  def initialize; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/action_collection.rb:13
  def action_for_request(request); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/action_collection.rb:9
  def add(action_class); end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/groups_gate.rb:6
module Flipper::UI::Actions; end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/actors_gate.rb:8
class Flipper::UI::Actions::ActorsGate < ::Flipper::UI::Action
  include ::Flipper::UI::Action::FeatureNameFromRoute

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/actors_gate.rb:13
  def get; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/actors_gate.rb:25
  def post; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/add_feature.rb:7
class Flipper::UI::Actions::AddFeature < ::Flipper::UI::Action
  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/add_feature.rb:10
  def get; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/boolean_gate.rb:7
class Flipper::UI::Actions::BooleanGate < ::Flipper::UI::Action
  include ::Flipper::UI::Action::FeatureNameFromRoute

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/boolean_gate.rb:12
  def post; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/feature.rb:7
class Flipper::UI::Actions::Feature < ::Flipper::UI::Action
  include ::Flipper::UI::Action::FeatureNameFromRoute

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/feature.rb:27
  def delete; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/feature.rb:12
  def get; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/features.rb:8
class Flipper::UI::Actions::Features < ::Flipper::UI::Action
  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/features.rb:11
  def get; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/features.rb:38
  def post; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/file.rb:7
class Flipper::UI::Actions::File < ::Flipper::UI::Action
  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/file.rb:10
  def get; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/groups_gate.rb:7
class Flipper::UI::Actions::GroupsGate < ::Flipper::UI::Action
  include ::Flipper::UI::Action::FeatureNameFromRoute

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/groups_gate.rb:12
  def get; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/groups_gate.rb:24
  def post; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/home.rb:7
class Flipper::UI::Actions::Home < ::Flipper::UI::Action
  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/home.rb:10
  def get; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/percentage_of_actors_gate.rb:7
class Flipper::UI::Actions::PercentageOfActorsGate < ::Flipper::UI::Action
  include ::Flipper::UI::Action::FeatureNameFromRoute

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/percentage_of_actors_gate.rb:12
  def post; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/actions/percentage_of_time_gate.rb:7
class Flipper::UI::Actions::PercentageOfTimeGate < ::Flipper::UI::Action
  include ::Flipper::UI::Action::FeatureNameFromRoute

  # source://flipper-ui-0.25.1/lib/flipper/ui/actions/percentage_of_time_gate.rb:12
  def post; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:5
class Flipper::UI::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:65
  def initialize; end
  ...
  # Default is comma ",".
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:50
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:36
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:14
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:8
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:87
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:31
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:6
  def delete; end
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:41
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:19
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:23
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:27
  def fun; end
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:45
  ...
  # @return [Boolean]
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:83
  def show_feature_description_in_list?; end

  # @return [Boolean]
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:79
  def using_descriptions?; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:63
Flipper::UI::Configuration::DEFAULT_DESCRIPTIONS_SOURCE = T.let(T.unsafe(nil), Proc)

# source://flipper-ui-0.25.1/lib/flipper/ui/configuration.rb:52
Flipper::UI::Configuration::VALID_BANNER_CLASS_VALUES = T.let(T.unsafe(nil), Array)

# source://flipper-ui-0.25.1/lib/flipper/ui/decorators/gate.rb:5
module Flipper::UI::Decorators; end

# source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:8
class Flipper::UI::Decorators::Feature < ::SimpleDelegator
  include ::Comparable

  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:79
  def <=>(other); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:23
  def color_class; end

  # Internal: Used to preload description if descriptions_source is
  # configured for Flipper::UI.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:16
  def description; end
  ...
  #
  # source://RUBY_ROOT/delegate.rb:318
  def feature; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:58
  def gate_state_title; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:34
  def gates_in_words; end

  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:69
  def pretty_enabled_gate_names; end

  # Public: Returns name titleized.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:19
  def pretty_name; end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/decorators/feature.rb:73
Flipper::UI::Decorators::Feature::StateSortMap = T.let(T.unsafe(nil), Hash)

# source://flipper-ui-0.25.1/lib/flipper/ui/decorators/gate.rb:7
class Flipper::UI::Decorators::Gate < ::SimpleDelegator
  # @return [Gate] a new instance of Gate
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/gate.rb:13
  def initialize(gate, value = T.unsafe(nil)); end

  # Public: Returns instance as hash that is ready to be json dumped.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/gate.rb:19
  def as_json; end
  ...
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/decorators/gate.rb:11
  def value; end
end

# All flipper ui errors inherit from this.
#
# source://flipper-ui-0.25.1/lib/flipper/ui/error.rb:4
class Flipper::UI::Error < ::StandardError; end

# source://flipper-ui-0.25.1/lib/flipper/ui/middleware.rb:11
class Flipper::UI::Middleware
  # @return [Middleware] a new instance of Middleware
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/middleware.rb:12
  def initialize(app, options = T.unsafe(nil)); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/middleware.rb:36
  def call(env); end

  # source://flipper-ui-0.25.1/lib/flipper/ui/middleware.rb:40
  def call!(env); end
end

# source://flipper-ui-0.25.1/lib/flipper/ui/configuration/option.rb:3
class Flipper::UI::Option
  # @return [Option] a new instance of Option
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration/option.rb:6
  def initialize(title, description); end

  # Returns the value of attribute description.
  #
  # source://flipper-ui-0.25.1/lib/flipper/ui/configuration/option.rb:4
  def description; end
...
#
# source://flipper-ui-0.25.1/lib/flipper/ui/error.rb:8
class Flipper::UI::RequestMethodNotSupported < ::Flipper::UI::Error; end

# source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:3
module Flipper::UI::Util
  class << self
    # @return [Boolean]
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:7
    def blank?(str); end

    # source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:27
    def pluralize(count, singular, plural); end

    # @return [Boolean]
    #
    # source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:11
    def present?(str); end

    # source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:15
    def titleize(str); end

    # source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:35
    def to_sentence(array, options = T.unsafe(nil)); end

    # source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:19
...
#
# source://flipper-ui-0.25.1/lib/flipper/ui/util.rb:5
