...
#
# source://dry-container-0.10.1/lib/dry/container/error.rb:3
module Dry
  class << self
...
#
# source://dry-container-0.10.1/lib/dry/container/error.rb:4
class Dry::Container
  ...
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:122
  def config; end
end

# @api public
#
# source://dry-container-0.10.1/lib/dry/container/mixin.rb:8
class Dry::Container::Config
  # @api private
  # @return [Config] a new instance of Config
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:23
  def initialize(namespace_separator: T.unsafe(nil), resolver: T.unsafe(nil), registry: T.unsafe(nil)); end

  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:14
  ...
  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:20
  def registry; end
  ...
  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:17
  def resolver; end
...
# @api public
#
# source://dry-container-0.10.1/lib/dry/container/mixin.rb:9
Dry::Container::Config::DEFAULT_NAMESPACE_SEPARATOR = T.let(T.unsafe(nil), String)

# @api public
#
# source://dry-container-0.10.1/lib/dry/container/mixin.rb:11
Dry::Container::Config::DEFAULT_REGISTRY = T.let(T.unsafe(nil), Dry::Container::Registry)

# @api public
#
# source://dry-container-0.10.1/lib/dry/container/mixin.rb:10
Dry::Container::Config::DEFAULT_RESOLVER = T.let(T.unsafe(nil), Dry::Container::Resolver)

# @api public
#
# source://dry-container-0.10.1/lib/dry/container/mixin.rb:35
module Dry::Container::Configuration
  # @api private
  # @yield [config]
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:57
  def configure; end
  ...
  class << self
    ...
    # @private
    #
    # source://dry-container-0.10.1/lib/dry/container/mixin.rb:39
    def extended(klass); end
  end
end

# source://dry-container-0.10.1/lib/dry/container/mixin.rb:66
Dry::Container::EMPTY_HASH = T.let(T.unsafe(nil), Hash)

# @api public
#
# source://dry-container-0.10.1/lib/dry/container/error.rb:6
...
# @api abstract
#
# source://dry-container-0.10.1/lib/dry/container/item.rb:9
class Dry::Container::Item
  # @api abstract
  # @return [Item] a new instance of Item
  #
  # source://dry-container-0.10.1/lib/dry/container/item.rb:17
  def initialize(item, options = T.unsafe(nil)); end

  # @api abstract
  # @raise [NotImplementedError]
  #
  # source://dry-container-0.10.1/lib/dry/container/item.rb:25
  def call; end
  ...
  # @return [Boolean]
  #
  # source://dry-container-0.10.1/lib/dry/container/item.rb:35
  def callable?; end

  # @api abstract
  # @return [Mixed] the item to be solved later
  #
  # source://dry-container-0.10.1/lib/dry/container/item.rb:11
  def item; end
  ...
  # @private
  #
  # source://dry-container-0.10.1/lib/dry/container/item.rb:42
  def map(func); end

  # @api abstract
  # @return [Hash] the options to memoize, call or no.
  #
  # source://dry-container-0.10.1/lib/dry/container/item.rb:14
  def options; end
  ...
  # @return [Boolean]
  #
  # source://dry-container-0.10.1/lib/dry/container/item.rb:30
  def value?; end
end
...
# @api public
#
# source://dry-container-0.10.1/lib/dry/container/item/callable.rb:15
class Dry::Container::Item::Callable < ::Dry::Container::Item
  ...
  # @return [Mixed]
  #
  # source://dry-container-0.10.1/lib/dry/container/item/callable.rb:16
  def call; end
end
...
# @api public
#
# source://dry-container-0.10.1/lib/dry/container/item/factory.rb:12
class Dry::Container::Item::Factory
  ...
  #
  # source://dry-container-0.10.1/lib/dry/container/item/factory.rb:20
...
# @api public
#
# source://dry-container-0.10.1/lib/dry/container/item/memoizable.rb:13
class Dry::Container::Item::Memoizable < ::Dry::Container::Item
  ...
  # @return [Dry::Container::Item::Base]
  #
  # source://dry-container-0.10.1/lib/dry/container/item/memoizable.rb:24
  def initialize(item, options = T.unsafe(nil)); end
  ...
  # @return [Dry::Container::Item::Base]
  #
  # source://dry-container-0.10.1/lib/dry/container/item/memoizable.rb:34
  def call; end

  # @api public
  # @return [Mutex] the stored mutex
  #
  # source://dry-container-0.10.1/lib/dry/container/item/memoizable.rb:14
  ...
  # @raise [::Dry::Container::Error]
  #
  # source://dry-container-0.10.1/lib/dry/container/item/memoizable.rb:43
  def raise_not_supported_error; end
end

# source://dry-container-0.10.1/lib/dry/container/error.rb:8
...
#   => 'item'
#
# source://dry-container-0.10.1/lib/dry/container/mixin.rb:90
module Dry::Container::Mixin
  ...
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:183
  def [](key); end

  # @api public
  # @private no, really
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:327
  def _container; end

  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:339
  def clone; end
  ...
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:266
  def decorate(key, with: T.unsafe(nil), &block); end

  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:332
  def dup; end
  ...
  # @return [Enumerator]
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:257
  def each(&block); end
  ...
  # @return [Dry::Container::Mixin] self
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:240
  ...
  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:320
  def freeze; end
  ...
  # @return [Dry::Container::Mixin] self
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:311
  ...
  # @return [Array<String>]
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:229
  def keys; end
  ...
  # @return [Dry::Container::Mixin] self
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:197
  ...
  # @return [Dry::Container::Mixin] self
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:292
  ...
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:143
  ...
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:170
  ...
  class << self
    ...
    # @private
    #
    # source://dry-container-0.10.1/lib/dry/container/mixin.rb:92
    ...
    # @private
    #
    # source://dry-container-0.10.1/lib/dry/container/mixin.rb:117
...
# @private
#
# source://dry-container-0.10.1/lib/dry/container/mixin.rb:109
module Dry::Container::Mixin::Initializer
  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/mixin.rb:110
...
#   => 'item'
#
# source://dry-container-0.10.1/lib/dry/container/namespace.rb:22
class Dry::Container::Namespace
  ...
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace.rb:38
  def initialize(name, &block); end

  # @api public
  # @return [Proc] The block to be executed when the namespace is imported
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace.rb:26
  def block; end

  # @api public
  # @return [Mixed] The namespace (name)
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace.rb:24
  def name; end
end

# @api private
#
# source://dry-container-0.10.1/lib/dry/container/namespace_dsl.rb:22
class Dry::Container::NamespaceDSL < ::SimpleDelegator
  ...
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace_dsl.rb:23
  def initialize(container, namespace, namespace_separator, &block); end

  # @api private
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace_dsl.rb:44
  def import(namespace); end

  # @api private
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace_dsl.rb:40
  def namespace(namespace, &block); end

  # @api private
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace_dsl.rb:36
  def register(key, *args, &block); end

  # @api private
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace_dsl.rb:50
  def resolve(key); end
  ...
  # @api private
  #
  # source://dry-container-0.10.1/lib/dry/container/namespace_dsl.rb:56
  def namespaced(key); end
end

# source://dry-container-0.10.1/lib/dry/container/mixin.rb:62
...
# @api public
#
# source://dry-container-0.10.1/lib/dry/container/registry.rb:10
class Dry::Container::Registry
  # @api public
  # @private
  # @return [Registry] a new instance of Registry
  #
  # source://dry-container-0.10.1/lib/dry/container/registry.rb:12
  def initialize; end
  ...
  # @return [Mixed]
  #
  # source://dry-container-0.10.1/lib/dry/container/registry.rb:34
  def call(container, key, item, options); end

  # @api public
  #
  # source://dry-container-0.10.1/lib/dry/container/registry.rb:45
  def factory; end
end
...
# @api public
#
# source://dry-container-0.10.1/lib/dry/container/resolver.rb:8
class Dry::Container::Resolver
  ...
  # @yieldparam key [Mixed] Missing key
  #
  # source://dry-container-0.10.1/lib/dry/container/resolver.rb:26
  ...
  # @return Key, Value
  #
  # source://dry-container-0.10.1/lib/dry/container/resolver.rb:83
  ...
  # @return Hash
  #
  # source://dry-container-0.10.1/lib/dry/container/resolver.rb:68
  ...
  # @return [Bool]
  #
  # source://dry-container-0.10.1/lib/dry/container/resolver.rb:48
  ...
  # @return [Array]
  #
  # source://dry-container-0.10.1/lib/dry/container/resolver.rb:57
  def keys(container); end
end

# @api public
#
# source://dry-container-0.10.1/lib/dry/container/version.rb:6
