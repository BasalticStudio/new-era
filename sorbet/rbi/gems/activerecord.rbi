...
class ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def self.register_class_with_precision(mapping, key, klass); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::Column < ActiveRecord::ConnectionAdapters::Column
  ...
  def hash; end
  def init_with(coder); end
  def initialize(*arg0, serial: nil, generated: nil, **arg3); end
  def oid(*, &); end
  def serial?; end
  def sql_type; end
  def virtual?; end
...
module ActiveRecord::ConnectionAdapters::PostgreSQL::DatabaseStatements
  ...
  def exec_delete(sql, name = nil, binds = nil); end
  def exec_insert(sql, name = nil, binds = nil, pk = nil, sequence_name = nil); end
  def exec_query(sql, name = nil, binds = nil, prepare: nil, async: nil); end
  def exec_rollback_db_transaction; end
  def exec_update(sql, name = nil, binds = nil); end
  def execute(sql, name = nil); end
  def execute_batch(statements, name = nil); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQLAdapter < ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def enable_extension(name); end
  def enum_types; end
  def exec_cache(sql, name, binds, async: nil); end
  def exec_no_cache(sql, name, binds, async: nil); end
  def execute_and_clear(sql, name, binds, prepare: nil, async: nil); end
...
class ActiveRecord::Associations::Preloader
  ...
  def call; end
  def empty?; end
  def initialize(records:, associations:, scope: nil, available_records: nil, associate_by_default: nil); end
  def loaders; end
  def records; end
  def scope; end
  extend ActiveSupport::Autoload
...
class ActiveRecord::Associations::Preloader::Branch
  ...
  def preloaded_records=(arg0); end
...
class ActiveRecord::Associations::Preloader::Association
  ...
  def klass; end
  def load_records(raw_records = nil); end
...
class ActiveRecord::Encryption::Scheme
  ...
  def fixed?; end
  def ignore_case?; end
  def initialize(key_provider: nil, key: nil, deterministic: nil, downcase: nil, ignore_case: nil, previous_schemes: nil, **context_properties); end
  def key_provider; end
  ...
  def validate_credential(key, error_message = nil); end
