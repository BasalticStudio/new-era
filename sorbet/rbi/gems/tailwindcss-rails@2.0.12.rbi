...
# source://tailwindcss-rails-2.0.12/lib/tailwindcss-rails.rb:1
module Tailwindcss; end

# source://tailwindcss-rails-2.0.12/lib/tailwindcss/engine.rb:4
class Tailwindcss::Engine < ::Rails::Engine; end

# constants describing the upstream tailwindcss project
#
# source://tailwindcss-rails-2.0.12/lib/tailwindcss/upstream.rb:3
module Tailwindcss::Upstream; end

# rubygems platform name => upstream release filename
#
# source://tailwindcss-rails-2.0.12/lib/tailwindcss/upstream.rb:7
Tailwindcss::Upstream::NATIVE_PLATFORMS = T.let(T.unsafe(nil), Hash)

# source://tailwindcss-rails-2.0.12/lib/tailwindcss/upstream.rb:4
Tailwindcss::Upstream::VERSION = T.let(T.unsafe(nil), String)

# source://tailwindcss-rails-2.0.12/lib/tailwindcss/version.rb:2
