...
class Flipper::Adapters::Memory
  ...
  #
  # source://flipper//lib/flipper/adapters/memory.rb#28
  def add(feature); end

  # Public: Clears all the gate values for a feature.
  #
  # source://flipper//lib/flipper/adapters/memory.rb#41
  def clear(feature); end

  # Public
  #
  # source://flipper//lib/flipper/adapters/memory.rb#87
  def disable(feature, gate, thing); end

  # Public
  #
  # source://flipper//lib/flipper/adapters/memory.rb#66
  def enable(feature, gate, thing); end

  # Public: The set of known features.
  #
  # source://flipper//lib/flipper/adapters/memory.rb#23
  def features; end
  ...
  # source://flipper//lib/flipper/adapters/memory.rb#61
  def get_all; end

  # source://flipper//lib/flipper/adapters/memory.rb#51
  def get_multi(features); end
  ...
  #
  # source://flipper//lib/flipper/adapters/memory.rb#35
  def remove(feature); end
end
...
class Flipper::Feature
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/feature.rb#228
  def conditional?; end
  ...
  # Returns result of disable.
  #
  # source://flipper//lib/flipper/feature.rb#167
  ...
  # Returns result of disable.
  #
  # source://flipper//lib/flipper/feature.rb#177
  ...
  # Returns result of disable.
  #
  # source://flipper//lib/flipper/feature.rb#187
  ...
  #
  # source://flipper//lib/flipper/feature.rb#127
  ...
  # Returns result of enable.
  #
  # source://flipper//lib/flipper/feature.rb#157
  ...
  # Returns result of enable.
  #
  # source://flipper//lib/flipper/feature.rb#147
  ...
  #
  # source://flipper//lib/flipper/feature.rb#358
  def gate(name); end
  ...
  #
  # source://flipper//lib/flipper/feature.rb#368
  def gate_for(thing); end

  # Public: Returns the raw gate values stored by the adapter.
  #
  # source://flipper//lib/flipper/feature.rb#233
  def gate_values; end
  ...
  # source://flipper//lib/flipper/feature.rb#345
  def gates_hash; end
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/feature.rb#217
  def on?; end
  ...
  #
  # source://flipper//lib/flipper/feature.rb#202
  def state; end
  ...
  #
  # source://flipper//lib/flipper/feature.rb#375
...
class Flipper::FeatureCheckContext
  ...
  def initialize(feature_name:, values:, thing:); end
...
class Flipper::Gates::Actor < ::Flipper::Gate
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/gates/actor.rb#34
  def protects?(thing); end

  # source://flipper//lib/flipper/gates/actor.rb#30
  def wrap(thing); end
end
...
class Flipper::Gates::Group < ::Flipper::Gate
  ...
  # source://flipper//lib/flipper/gates/group.rb#33
  def wrap(thing); end
end
...
class Flipper::Gates::PercentageOfActors < ::Flipper::Gate
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/gates/percentage_of_actors.rb#39
  def protects?(thing); end
end
