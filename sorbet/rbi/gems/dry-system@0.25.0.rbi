...
# source://dry-system-0.25.0/lib/dry/system/constants.rb:5
module Dry
  class << self
...
# source://dry-system-0.25.0/lib/dry/system/constants.rb:6
module Dry::System
  ...
  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system.rb:58
    def provider_sources; end

    # source://dry-system-0.25.0/lib/dry/system.rb:46
    def register_component(name, provider:, &block); end

    # source://dry-system-0.25.0/lib/dry/system.rb:15
    ...
    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system.rb:29
    ...
    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system.rb:11
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/auto_registrar.rb:16
class Dry::System::AutoRegistrar
  # @api private
  # @return [AutoRegistrar] a new instance of AutoRegistrar
  #
  # source://dry-system-0.25.0/lib/dry/system/auto_registrar.rb:19
  def initialize(container); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/auto_registrar.rb:31
  def call(component_dir); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/auto_registrar.rb:17
  def container; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/auto_registrar.rb:24
  def finalize!; end
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/auto_registrar.rb:41
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/component.rb:20
class Dry::System::Component
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:45
  def initialize(identifier, file_path:, namespace:, **options); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:165
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:144
  def const_path; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:34
  def file_path; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:30
  def identifier; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:160
  def inflector; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:68
  ...
  # @see Identifier#key
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:80
  def key; end
  ...
  # @return [TrueClass]
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:60
  def loadable?; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:155
  def loader; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:170
  def memoize?; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:38
  def namespace; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:42
  def options; end
  ...
  # @see Config::Namespace
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:114
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:91
  def root_key; end
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:187
  def callable_option?(value); end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/component.rb:176
  def path_in_namespace; end
end

# @api public
#
# source://dry-system-0.25.0/lib/dry/system/component.rb:23
...
#
# source://dry-system-0.25.0/lib/dry/system/component_dir.rb:17
class Dry::System::ComponentDir
  # @api private
  # @return [ComponentDir] a new instance of ComponentDir
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:29
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:44
  def component_for_key(key); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:21
  def config; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:26
  def container; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:58
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:137
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:103
  def component_for_path(path, namespace); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:152
  def component_options; end

  # @api private
  # @raise [ComponentDirNotFoundError]
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:68
  def each_file; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:80
  def files(namespace); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:118
  ...
  # @return [Pathname]
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:95
  def full_path; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:161
  def method_missing(name, *args, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/component_dir.rb:169
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:12
class Dry::System::ComponentDirAlreadyAddedError < ::StandardError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:13
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:21
class Dry::System::ComponentDirNotFoundError < ::StandardError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:22
  def initialize(dir); end
end
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:99
class Dry::System::ComponentNotLoadableError < ::NameError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:101
  def initialize(component, error, corrections: T.unsafe(nil)); end
end

# source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:8
module Dry::System::Config; end

# @api public
#
# source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:13
class Dry::System::Config::ComponentDir
  ...
  #
  # source://dry-configurable-0.15.0/lib/dry/configurable/instance_methods.rb:14
  def initialize(*_arg0); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:246
  def auto_register?; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:262
  def configured?(key); end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:216
  def default_namespace; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:198
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:236
  def path; end
  ...
  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:276
  def method_missing(name, *args, &block); end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dir.rb:284
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end
end
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:13
class Dry::System::Config::ComponentDirs
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:107
  def initialize; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:126
  def [](path); end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:165
  ...
  # @see #method_missing
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:102
  def defaults; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:186
  def delete(path); end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:225
  def each(&block); end
  ...
  # @return [Integer]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:204
  def length; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:195
  def paths; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:214
  def to_a; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:242
  def dirs; end
  ...
  # @return [void]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:268
  def apply_defaults_to_dir(dir); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:113
  def initialize_copy(source); end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:276
  def method_missing(name, *args, &block); end
  ...
  # @see #add
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:253
  def path_and_dir(path_or_dir); end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/component_dirs.rb:284
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end
end
...
# @see Namespaces#add
#
# source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:26
class Dry::System::Config::Namespace
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:56
  def initialize(path:, key:, const:); end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:38
  def const; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:35
  def key; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:32
  def path; end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:70
  def path?; end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:65
  def root?; end
  ...
  class << self
    ...
    #
    # source://dry-system-0.25.0/lib/dry/system/config/namespace.rb:47
...
#
# source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:15
class Dry::System::Config::Namespaces
  # @api private
  # @return [Namespaces] a new instance of Namespaces
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:20
  def initialize; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:36
  def [](path); end
  ...
  # @see Namespace
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:111
  ...
  # @see #add
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:124
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:137
  def delete(path); end
  ...
  # @return [Namespace, nil]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:148
  def delete_root; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:202
  def each(&block); end
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:177
  def empty?; end
  ...
  # @return [Integer]
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:167
  def length; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:17
  def namespaces; end
  ...
  #   namespace
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:158
  def paths; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:47
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:190
  def to_a; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/config/namespaces.rb:25
  def initialize_copy(source); end
end
...
#   end
#
# source://dry-system-0.25.0/lib/dry/system/container.rb:72
class Dry::System::Container
  ...
  class << self
    ...
    # @return [self]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:463
    ...
    # @return [self]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:637
    def after(event, &block); end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:587
    ...
    # @return [self]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:615
    def before(event, &block); end

    # @api public
    # @see .register_provider
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:314
    ...
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:576
    ...
    # @see after
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:128
    ...
    # @see after
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:155
    def configured!(finalize_config: T.unsafe(nil)); end

    # @api public
    # @return [Boolean]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:165
    def configured?; end
    ...
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:370
    ...
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:337
    def finalized?; end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:643
    def hooks; end
    ...
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:195
    def import(keys: T.unsafe(nil), from: T.unsafe(nil), as: T.unsafe(nil), **deprecated_import_hash); end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:597
    def importer; end

    # @api private
    # @private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:648
    ...
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:501
    ...
    # @return [Boolean]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:566
    def key?(key); end

    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:471
    def load_registrations!(name); end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:592
    ...
    # @return [self]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:420
    def prepare(name); end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:581
    def providers; end

    # @api public
    # @overload register_provider
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:306
    ...
    # @return [Boolean]
    #
    # source://dry-container-0.10.1/lib/dry/container/mixin.rb:220
    ...
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:517
    def require_from_root(*paths); end

    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:544
    def resolve(key); end
    ...
    # @return [Pathname]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:539
    def root; end

    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:442
    def shutdown!; end
    ...
    # @return [self]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:402
    def start(name); end
    ...
    # @return [self]
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:436
    def stop(name); end
    ...
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:663
    ...
    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:706
    def find_component(key); end

    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:698
    def load_imported_component(identifier, namespace:); end

    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system/container.rb:692
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/identifier.rb:15
class Dry::System::Identifier
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:23
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:83
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:104
  def include?(segments); end

  # @api public
  # @return [String] the identifier's string key
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:20
  def key; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:125
  ...
  # @see #initialize
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:150
  ...
  # @return [Symbol] the root key
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:43
  def root_key; end
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:62
  ...
  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/identifier.rb:172
  def segments; end
end
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/importer.rb:16
class Dry::System::Importer
  # @api private
  # @return [Importer] a new instance of Importer
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:33
  def initialize(container); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:48
  def [](name); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:28
  def container; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:59
  def finalize!; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:65
  def import(namespace, keys: T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:53
  def key?(name); end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:39
  def register(namespace:, container:, keys: T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:30
  def registry; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:108
  def build_merge_container(other, keys); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:90
  def import_all(other, namespace); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:86
  def import_keys(other, namespace, keys); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:80
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:102
  def merge(container, other, namespace:); end
end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/importer.rb:18
class Dry::System::Importer::Item
  # @api private
  # @return [Item] a new instance of Item
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:21
  def initialize(namespace:, container:, import_keys:); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/importer.rb:19
  def container; end
...
#
# source://dry-system-0.25.0/lib/dry/system/indirect_component.rb:18
class Dry::System::IndirectComponent
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/indirect_component.rb:26
  def initialize(identifier); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/indirect_component.rb:23
  def identifier; end
  ...
  # @see Identifier#key
  #
  # source://dry-system-0.25.0/lib/dry/system/indirect_component.rb:49
  def key; end
  ...
  # @return [FalseClass]
  #
  # source://dry-system-0.25.0/lib/dry/system/indirect_component.rb:38
  def loadable?; end
  ...
  # @see Identifier#root_key
  #
  # source://dry-system-0.25.0/lib/dry/system/indirect_component.rb:60
  def root_key; end
end

Dry::System::InvalidComponentError = Dry::System::ProviderNotFoundError

# source://dry-system-0.25.0/lib/dry/system/constants.rb:12
...
#   end
#
# source://dry-system-0.25.0/lib/dry/system/loader.rb:27
class Dry::System::Loader
  class << self
    ...
    # @return [Object]
    #
    # source://dry-system-0.25.0/lib/dry/system/loader.rb:46
    ...
    # @return [Class]
    #
    # source://dry-system-0.25.0/lib/dry/system/loader.rb:64
    ...
    # @api public
    #
    # source://dry-system-0.25.0/lib/dry/system/loader.rb:32
    ...
    # @return [Boolean]
    #
    # source://dry-system-0.25.0/lib/dry/system/loader.rb:74
    def singleton?(constant); end
  end
end

# source://dry-system-0.25.0/lib/dry/system/magic_comments_parser.rb:5
class Dry::System::MagicCommentsParser
  class << self
    # source://dry-system-0.25.0/lib/dry/system/magic_comments_parser.rb:14
    def call(file_name); end

    # source://dry-system-0.25.0/lib/dry/system/magic_comments_parser.rb:26
    def coerce(value); end
  end
end

# source://dry-system-0.25.0/lib/dry/system/magic_comments_parser.rb:9
Dry::System::MagicCommentsParser::COERCIONS = T.let(T.unsafe(nil), Hash)

# source://dry-system-0.25.0/lib/dry/system/magic_comments_parser.rb:7
Dry::System::MagicCommentsParser::COMMENT_RE = T.let(T.unsafe(nil), Regexp)

# source://dry-system-0.25.0/lib/dry/system/magic_comments_parser.rb:6
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:14
class Dry::System::ManifestRegistrar
  # @api private
  # @return [ManifestRegistrar] a new instance of ManifestRegistrar
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:22
  def initialize(container); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:35
  def call(component); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:19
  def config; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:16
  def container; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:40
  def file_exists?(component); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:28
  def finalize!; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:47
  def registrations_dir; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/manifest_registrar.rb:52
  def root; end
end
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:31
class Dry::System::NamespaceAlreadyAddedError < ::StandardError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:32
  def initialize(path); end
end

# source://dry-system-0.25.0/lib/dry/system/constants.rb:11
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:88
class Dry::System::PluginDependencyMissing < ::StandardError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:90
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:79
class Dry::System::PluginNotFoundError < ::StandardError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:80
  def initialize(plugin_name); end
end

# source://dry-system-0.25.0/lib/dry/system/plugins.rb:7
module Dry::System::Plugins
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:113
  def enabled_plugins; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:107
  def inherited(klass); end
  ...
  # @return [self]
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:93
  def use(name, **options); end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins.rb:80
    ...
    # @return [Plugins]
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins.rb:70
    def register(name, plugin, &block); end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins.rb:75
    def registry; end
  end
end

# source://dry-system-0.25.0/lib/dry/system/plugins/bootsnap.rb:6
module Dry::System::Plugins::Bootsnap
  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/bootsnap.rb:39
  ...
  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/bootsnap.rb:32
  def setup_bootsnap; end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/bootsnap.rb:25
    def dependencies; end

    # @api private
    # @private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/bootsnap.rb:16
    def extended(system); end
  end
end

# source://dry-system-0.25.0/lib/dry/system/plugins/bootsnap.rb:7
Dry::System::Plugins::Bootsnap::DEFAULT_OPTIONS = T.let(T.unsafe(nil), Hash)

# @api public
#
# source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:6
module Dry::System::Plugins::DependencyGraph
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph.rb:34
  def injector(**options); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph.rb:39
  def register(key, contents = T.unsafe(nil), options = T.unsafe(nil), &block); end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph.rb:29
    def dependencies; end

    # @api private
    # @private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph.rb:11
    def extended(system); end
  end
end
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:8
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:28
class Dry::System::Plugins::DependencyGraph::Strategies::Args < ::Dry::AutoInject::Strategies::Args
  private

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:32
  def define_initialize(klass); end
end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:43
class Dry::System::Plugins::DependencyGraph::Strategies::Hash < ::Dry::AutoInject::Strategies::Hash
  private

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:47
  def define_initialize(klass); end
end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:12
class Dry::System::Plugins::DependencyGraph::Strategies::Kwargs < ::Dry::AutoInject::Strategies::Kwargs
  private

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/dependency_graph/strategies.rb:16
  def define_initialize(klass); end
end

# @api public
#
# source://dry-system-0.25.0/lib/dry/system/plugins/env.rb:7
class Dry::System::Plugins::Env < ::Module
  # @api private
  # @return [Env] a new instance of Env
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/env.rb:13
  def initialize(**options); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/env.rb:23
  def extended(system); end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/env.rb:18
  def inferrer; end

  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/env.rb:10
  def options; end
end

# @api public
#
# source://dry-system-0.25.0/lib/dry/system/plugins/env.rb:8
Dry::System::Plugins::Env::DEFAULT_INFERRER = T.let(T.unsafe(nil), Proc)

# source://dry-system-0.25.0/lib/dry/system/plugins/logging.rb:8
module Dry::System::Plugins::Logging
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/logging.rb:57
  def log_dir_path; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/logging.rb:67
  def log_file_name; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/logging.rb:62
  def log_file_path; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/logging.rb:52
  def log_level; end
  ...
  # @return [self]
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/logging.rb:37
  ...
  class << self
    ...
    # @private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/logging.rb:10
    def extended(system); end
  end
end
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/plugins/monitoring/proxy.rb:8
module Dry::System::Plugins::Monitoring
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/monitoring.rb:28
  def monitor(key, **options, &block); end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/monitoring.rb:23
    def dependencies; end

    # @api private
    # @private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/monitoring.rb:12
    def extended(system); end
  end
end
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/plugins/monitoring/proxy.rb:11
class Dry::System::Plugins::Monitoring::Proxy < ::SimpleDelegator
  # @api private
  # @return [Proxy] a new instance of Proxy
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/monitoring/proxy.rb:43
  def initialize(target, notifications); end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/monitoring/proxy.rb:12
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/plugins/notifications.rb:7
module Dry::System::Plugins::Notifications
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/notifications.rb:19
  def register_notifications; end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/notifications.rb:14
    def dependencies; end

    # @api private
    # @private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/notifications.rb:9
    def extended(system); end
  end
end
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/plugins.rb:9
class Dry::System::Plugins::Plugin
  # @api private
  # @return [Plugin] a new instance of Plugin
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:17
  def initialize(name, mod, &block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:24
  def apply_to(system, **options); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:14
  def block; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:31
  def load_dependencies(dependencies = T.unsafe(nil), gem = T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:42
  def load_dependency(dependency, gem); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:12
  def mod; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:55
  def mod_dependencies; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:10
  def name; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins.rb:50
  def stateful?; end
end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:10
class Dry::System::Plugins::Zeitwerk < ::Module
  # @api private
  # @return [Zeitwerk] a new instance of Zeitwerk
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:23
  def initialize(loader: T.unsafe(nil), run_setup: T.unsafe(nil), eager_load: T.unsafe(nil), debug: T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:20
  def debug; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:32
  def extended(system); end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:61
  def configure_loader(loader, system); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:101
  def eager_load?(system); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:95
  def get_or_define_module(parent_mod, name); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:83
  ...
  # @return [Zeitwerk::Loader]
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:70
  def push_component_dirs_to_loader(system, loader); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:46
  def setup_autoloader(system); end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/plugins/zeitwerk.rb:11
    def dependencies; end
  end
end
...
#
# source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:7
class Dry::System::Provider
  # @api private
  # @return [Provider] a new instance of Provider
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:132
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:98
  def container; end
  ...
  # @return [Symbol]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:62
  def name; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:69
  def namespace; end
  ...
  # @return [self]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:156
  def prepare; end
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:189
  def prepared?; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:129
  def source; end
  ...
  # @return [self]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:168
  def start; end
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:196
  def started?; end
  ...
  # @return [Array<Symbol>]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:79
  def statuses; end
  ...
  # @return [self]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:180
  def stop; end
  ...
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:203
  def stopped?; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:112
  def target; end
  ...
  # @return [self]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:268
  def apply; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:210
  def build_provider_container; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:227
  ...
  # @return [Symbol, nil]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:86
  ...
  # @see {#run_step}
  #
  # source://dry-system-0.25.0/lib/dry/system/provider.rb:257
  def step_running?; end
end
...
#
# source://dry-system-0.25.0/lib/dry/system/provider/source.rb:37
class Dry::System::Provider::Source
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:128
  ...
  # @see #before
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:248
  ...
  # @see #after
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:219
  def before(step_name, &block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:92
  def callbacks; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:107
  def container; end
  ...
  # @return [String]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:141
  def inspect; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:159
  def prepare; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:265
  ...
  # @see SourceDSL#start
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:174
  def start; end
  ...
  # @see SourceDSL#stop
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:189
  def stop; end
  ...
  # @see Dry::System::Provider
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:124
  def target; end
  ...
  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:191
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:314
  def method_missing(name, *args, &block); end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:292
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:303
  def resolve(key); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:323
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:308
  ...
  class << self
    ...
    #
    # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:45
    def for(name:, target_container:, group: T.unsafe(nil), &block); end

    # @api public
    # @private
    #
    # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:53
    def inherited(subclass); end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:80
    def inspect; end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:67
    def name; end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/provider/source.rb:75
    def to_s; end
  end
end
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/provider/source.rb:85
...
# @see Dry::System::Container.register_provider
#
# source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:14
class Dry::System::Provider::SourceDSL
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:32
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:65
  def prepare(&block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:36
  def setting(*_arg0, &_arg1); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:42
  def settings(&block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:30
  def source_class; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:70
  def start(&block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:74
  def stop(&block); end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:80
  def method_missing(name, *args, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:88
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:17
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:55
class Dry::System::Provider::SourceDSL::DeprecatedSettingsDSL
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:56
  def initialize(base_dsl); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider/source_dsl.rb:60
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:43
class Dry::System::ProviderAlreadyRegisteredError < ::ArgumentError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:44
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:54
class Dry::System::ProviderNotFoundError < ::ArgumentError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:55
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:19
class Dry::System::ProviderRegistrar
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:29
  def initialize(container); end
  ...
  # @api public
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:80
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:26
  def container; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:146
  def finalize!; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:95
  def find_and_load_provider(name); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:35
  def freeze; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:86
  def key?(provider_name); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:170
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:129
  def provider_files; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:23
  def providers; end
  ...
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:44
  def register_provider(name, namespace: T.unsafe(nil), from: T.unsafe(nil), source: T.unsafe(nil), if: T.unsafe(nil), &block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:164
  def shutdown; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:176
  def start(provider_name); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:110
  def start_provider_dependency(component); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:182
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:220
  def build_provider(name, namespace:, source: T.unsafe(nil), &block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:235
  def build_provider_from_source(name, source:, group:, namespace:, &block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:271
  def find_provider_file(name); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:257
  def load_provider(path); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:191
  def provider_paths; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:265
  ...
  # @yield [provider]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_registrar.rb:247
...
# @api public
#
# source://dry-system-0.25.0/lib/dry/system/errors.rb:65
class Dry::System::ProviderSourceNotFoundError < ::StandardError
  # source://dry-system-0.25.0/lib/dry/system/errors.rb:66
  def initialize(name:, group:, keys:); end
end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:10
class Dry::System::ProviderSourceRegistry
  # @api private
  # @return [ProviderSourceRegistry] a new instance of ProviderSourceRegistry
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:13
  def initialize; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:17
  def load_sources(path); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:23
  def register(name:, group:, source:); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:27
  def register_from_block(name:, group:, target_container:, &block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:40
  def resolve(name:, group:); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:11
  def sources; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_source_registry.rb:65
  def key(name, group); end
end

# source://dry-system-0.25.0/lib/dry/system/provider_sources/settings.rb:5
module Dry::System::ProviderSources; end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider_sources/settings.rb:6
module Dry::System::ProviderSources::Settings; end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:32
class Dry::System::ProviderSources::Settings::Config
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:71
  def method_missing(name, *args, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:79
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end

  class << self
    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:55
    def key(name, type); end

    # @api private
    #
    # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:34
...
# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:12
class Dry::System::ProviderSources::Settings::InvalidSettingsError < ::ArgumentError
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:14
  def initialize(errors); end

  private

  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/config.rb:26
  def setting_errors(errors); end
end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/loader.rb:11
class Dry::System::ProviderSources::Settings::Loader
  # @api private
  # @return [Loader] a new instance of Loader
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/loader.rb:16
  def initialize(root:, env:, store: T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/loader.rb:22
  def [](key); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/loader.rb:13
  def store; end
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/loader.rb:41
  def dotenv_files(root, env); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings/loader.rb:28
  def load_dotenv(root, env); end
end

# @api private
#
# source://dry-system-0.25.0/lib/dry/system/provider_sources/settings.rb:7
class Dry::System::ProviderSources::Settings::Source < ::Dry::System::Provider::Source
  ...
  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings.rb:10
  def prepare; end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings.rb:18
  def settings(&block); end

  # @api private
  #
  # source://dry-system-0.25.0/lib/dry/system/provider_sources/settings.rb:14
  def start; end
end

# source://dry-system-0.25.0/lib/dry/system/constants.rb:9
Dry::System::RB_EXT = T.let(T.unsafe(nil), String)

# source://dry-system-0.25.0/lib/dry/system/constants.rb:10
...
# source://dry-system-0.25.0/lib/dry/system/constants.rb:13
