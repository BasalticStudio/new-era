...
class File < IO
  def self.expand_path(*arg0); end
  def self.realpath(*arg0); end
end
...
class ActiveSupport::CodeGenerator
  def define_cached_method(name, namespace:, as: nil, &block); end
  def execute; end
...
class ActiveSupport::CodeGenerator::MethodSet
  ...
  def define_cached_method(name, as: nil); end
