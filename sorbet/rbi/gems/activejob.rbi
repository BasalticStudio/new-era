...
module ActiveJob::TestHelper
  ...
  def assert_enqueued_with(job: nil, args: nil, at: nil, queue: nil, priority: nil, &block); end
  ...
  def assert_performed_with(job: nil, args: nil, at: nil, queue: nil, priority: nil, &block); end
  ...
  def instantiate_job(payload, skip_deserialize_arguments: nil); end
