...
#
# source://dry-system//lib/dry/system/constants.rb#5
module Dry
  class << self
...
# source://dry-system//lib/dry/system/constants.rb#6
module Dry::System
  ...
  class << self
    ...
    # @api public
    #
    # source://dry-system//lib/dry/system.rb#29
    ...
    # @api public
    #
    # source://dry-system//lib/dry/system.rb#11
...
class Dry::System::AutoRegistrar
  ...
  #
  # source://dry-system//lib/dry/system/auto_registrar.rb#19
  def initialize(container); end

  # @api private
  #
  # source://dry-system//lib/dry/system/auto_registrar.rb#31
  def call(component_dir); end

  # @api private
  #
  # source://dry-system//lib/dry/system/auto_registrar.rb#17
  def container; end

  # @api private
  #
  # source://dry-system//lib/dry/system/auto_registrar.rb#24
  def finalize!; end
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/auto_registrar.rb#41
...
class Dry::System::Component
  ...
  #
  # source://dry-system//lib/dry/system/component.rb#43
  def initialize(identifier, file_path:, namespace:, **options); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/component.rb#163
  ...
  #
  # source://dry-system//lib/dry/system/component.rb#142
  def const_path; end

  # @api public
  #
  # source://dry-system//lib/dry/system/component.rb#32
  def file_path; end

  # @api public
  #
  # source://dry-system//lib/dry/system/component.rb#28
  def identifier; end

  # @api private
  #
  # source://dry-system//lib/dry/system/component.rb#158
  def inflector; end
  ...
  #
  # source://dry-system//lib/dry/system/component.rb#66
  ...
  # @see Identifier#key
  #
  # source://dry-system//lib/dry/system/component.rb#78
  def key; end
  ...
  # @return [TrueClass]
  #
  # source://dry-system//lib/dry/system/component.rb#58
  def loadable?; end

  # @api private
  #
  # source://dry-system//lib/dry/system/component.rb#153
  def loader; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/component.rb#168
  def memoize?; end

  # @api public
  #
  # source://dry-system//lib/dry/system/component.rb#36
  def namespace; end
  ...
  # @see Config::Namespace
  #
  # source://dry-system//lib/dry/system/component.rb#112
  ...
  #
  # source://dry-system//lib/dry/system/component.rb#89
  def root_key; end
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/component.rb#185
  def callable_option?(value); end

  # @api public
  #
  # source://dry-system//lib/dry/system/component.rb#174
  def path_in_namespace; end
end

# @api public
#
# source://dry-system//lib/dry/system/component.rb#21
...
#
# source://dry-system//lib/dry/system/component_dir.rb#17
class Dry::System::ComponentDir
  # @api private
  # @return [ComponentDir] a new instance of ComponentDir
  #
  # source://dry-system//lib/dry/system/component_dir.rb#29
  ...
  #
  # source://dry-system//lib/dry/system/component_dir.rb#44
  def component_for_key(key); end

  # @api private
  #
  # source://dry-system//lib/dry/system/component_dir.rb#21
  def config; end
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/component_dir.rb#58
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/component_dir.rb#137
  ...
  #
  # source://dry-system//lib/dry/system/component_dir.rb#103
  def component_for_path(path, namespace); end

  # @api private
  #
  # source://dry-system//lib/dry/system/component_dir.rb#152
  def component_options; end

  # @api private
  # @raise [ComponentDirNotFoundError]
  #
  # source://dry-system//lib/dry/system/component_dir.rb#68
  def each_file; end

  # @api private
  #
  # source://dry-system//lib/dry/system/component_dir.rb#80
  def files(namespace); end

  # @api private
  #
  # source://dry-system//lib/dry/system/component_dir.rb#118
  ...
  # @return [Pathname]
  #
  # source://dry-system//lib/dry/system/component_dir.rb#95
  def full_path; end

  # @api private
  #
  # source://dry-system//lib/dry/system/component_dir.rb#161
  def method_missing(name, *args, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/component_dir.rb#169
...
# @api public
#
# source://dry-system//lib/dry/system/errors.rb#12
class Dry::System::ComponentDirAlreadyAddedError < ::StandardError
  # source://dry-system//lib/dry/system/errors.rb#13
...
# @api public
#
# source://dry-system//lib/dry/system/errors.rb#21
class Dry::System::ComponentDirNotFoundError < ::StandardError
  # source://dry-system//lib/dry/system/errors.rb#22
  def initialize(dir); end
end
...
class Dry::System::ComponentNotLoadableError < ::NameError
  # source://dry-system//lib/dry/system/errors.rb#101
  def initialize(component, error, corrections: T.unsafe(nil)); end
end

# source://dry-system//lib/dry/system/config/namespace.rb#8
module Dry::System::Config; end

# @api public
#
# source://dry-system//lib/dry/system/config/component_dir.rb#13
class Dry::System::Config::ComponentDir
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/config/component_dir.rb#246
  def auto_register?; end

  # @api public
  #
  # source://dry-system//lib/dry/system/config/component_dir.rb#216
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dir.rb#236
  def path; end
  ...
  # @api public
  #
  # source://dry-system//lib/dry/system/config/component_dir.rb#252
  def method_missing(name, *args, &block); end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/config/component_dir.rb#260
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end
end
...
# @api public
#
# source://dry-system//lib/dry/system/config/component_dirs.rb#13
class Dry::System::Config::ComponentDirs
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#107
  def initialize; end
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#126
  def [](path); end
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#165
  ...
  # @see #method_missing
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#102
  def defaults; end
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#186
  def delete(path); end
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#225
  def each(&block); end
  ...
  # @return [Integer]
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#204
  def length; end
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#195
  def paths; end
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#214
  def to_a; end
  ...
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#242
  def dirs; end
  ...
  # @return [void]
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#268
  def apply_defaults_to_dir(dir); end

  # @api private
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#113
  def initialize_copy(source); end

  # @api public
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#276
  def method_missing(name, *args, &block); end
  ...
  # @see #add
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#253
  def path_and_dir(path_or_dir); end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/config/component_dirs.rb#284
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end
end
...
class Dry::System::Config::Namespace
  ...
  #
  # source://dry-system//lib/dry/system/config/namespace.rb#56
  def initialize(path:, key:, const:); end

  # @api public
  #
  # source://dry-system//lib/dry/system/config/namespace.rb#38
  def const; end

  # @api public
  #
  # source://dry-system//lib/dry/system/config/namespace.rb#35
  def key; end

  # @api public
  #
  # source://dry-system//lib/dry/system/config/namespace.rb#32
  def path; end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/config/namespace.rb#70
  def path?; end

  # @api public
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/config/namespace.rb#65
  def root?; end
  ...
  class << self
    ...
    #
    # source://dry-system//lib/dry/system/config/namespace.rb#47
...
# @api public
#
# source://dry-system//lib/dry/system/config/namespace.rb#27
...
#
# source://dry-system//lib/dry/system/config/namespaces.rb#16
class Dry::System::Config::Namespaces
  ...
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#23
  def initialize; end
  ...
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#39
  def [](path); end
  ...
  # @see Namespace
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#114
  ...
  # @see #add
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#127
  ...
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#140
  def delete(path); end
  ...
  # @return [Namespace, nil]
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#151
  def delete_root; end
  ...
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#205
  def each(&block); end
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#180
  def empty?; end
  ...
  # @return [Integer]
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#170
  def length; end
  ...
  #   namespace
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#161
  def paths; end
  ...
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#50
  ...
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#193
  def to_a; end
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/config/namespaces.rb#28
  def initialize_copy(source); end
end
...
#   end
#
# source://dry-system//lib/dry/system/container.rb#72
class Dry::System::Container
  ...
  class << self
    ...
    # @return [self]
    #
    # source://dry-system//lib/dry/system/container.rb#462
    ...
    # @return [self]
    #
    # source://dry-system//lib/dry/system/container.rb#636
    def after(event, &block); end

    # @api private
    #
    # source://dry-system//lib/dry/system/container.rb#586
    ...
    # @return [self]
    #
    # source://dry-system//lib/dry/system/container.rb#614
    def before(event, &block); end

    # @api public
    # @see .register_provider
    #
    # source://dry-system//lib/dry/system/container.rb#313
    ...
    # @api private
    #
    # source://dry-system//lib/dry/system/container.rb#575
    ...
    # @see after
    #
    # source://dry-system//lib/dry/system/container.rb#127
    ...
    # @return [Boolean]
    #
    # source://dry-system//lib/dry/system/container.rb#164
    def configured?; end
    ...
    #
    # source://dry-system//lib/dry/system/container.rb#369
    ...
    #
    # source://dry-system//lib/dry/system/container.rb#336
    def finalized?; end

    # @api private
    #
    # source://dry-system//lib/dry/system/container.rb#642
    def hooks; end
    ...
    #
    # source://dry-system//lib/dry/system/container.rb#194
    def import(keys: T.unsafe(nil), from: T.unsafe(nil), as: T.unsafe(nil), **deprecated_import_hash); end

    # @api private
    #
    # source://dry-system//lib/dry/system/container.rb#596
    def importer; end

    # @api private
    # @private
    #
    # source://dry-system//lib/dry/system/container.rb#647
    ...
    #
    # source://dry-system//lib/dry/system/container.rb#500
    ...
    # @return [Boolean]
    #
    # source://dry-system//lib/dry/system/container.rb#565
    def key?(key); end

    # @api public
    #
    # source://dry-system//lib/dry/system/container.rb#470
    def load_registrations!(name); end

    # @api private
    #
    # source://dry-system//lib/dry/system/container.rb#591
    ...
    # @return [self]
    #
    # source://dry-system//lib/dry/system/container.rb#419
    def prepare(name); end

    # @api private
    #
    # source://dry-system//lib/dry/system/container.rb#580
    def providers; end

    # @api public
    # @overload register_provider
    #
    # source://dry-system//lib/dry/system/container.rb#305
    ...
    #
    # source://dry-system//lib/dry/system/container.rb#516
    def require_from_root(*paths); end

    # @api public
    #
    # source://dry-system//lib/dry/system/container.rb#543
    def resolve(key); end
    ...
    # @return [Pathname]
    #
    # source://dry-system//lib/dry/system/container.rb#538
    def root; end

    # @api public
    #
    # source://dry-system//lib/dry/system/container.rb#441
    def shutdown!; end
    ...
    # @return [self]
    #
    # source://dry-system//lib/dry/system/container.rb#401
    def start(name); end
    ...
    # @return [self]
    #
    # source://dry-system//lib/dry/system/container.rb#435
    def stop(name); end
    ...
    # @api private
    #
    # source://dry-system//lib/dry/system/container.rb#662
    ...
    # @api public
    #
    # source://dry-system//lib/dry/system/container.rb#705
    def find_component(key); end

    # @api public
    #
    # source://dry-system//lib/dry/system/container.rb#697
    def load_imported_component(identifier, namespace:); end

    # @api public
    #
    # source://dry-system//lib/dry/system/container.rb#691
...
# @api public
#
# source://dry-system//lib/dry/system/identifier.rb#15
class Dry::System::Identifier
  ...
  #
  # source://dry-system//lib/dry/system/identifier.rb#23
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/identifier.rb#83
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/identifier.rb#104
  def include?(segments); end

  # @api public
  # @return [String] the identifier's string key
  #
  # source://dry-system//lib/dry/system/identifier.rb#20
  def key; end
  ...
  #
  # source://dry-system//lib/dry/system/identifier.rb#125
  ...
  # @see #initialize
  #
  # source://dry-system//lib/dry/system/identifier.rb#150
  ...
  # @return [Symbol] the root key
  #
  # source://dry-system//lib/dry/system/identifier.rb#43
  def root_key; end
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/identifier.rb#62
  ...
  # @api public
  #
  # source://dry-system//lib/dry/system/identifier.rb#172
  def segments; end
end
...
#
# source://dry-system//lib/dry/system/indirect_component.rb#18
class Dry::System::IndirectComponent
  ...
  #
  # source://dry-system//lib/dry/system/indirect_component.rb#26
  def initialize(identifier); end

  # @api private
  #
  # source://dry-system//lib/dry/system/indirect_component.rb#23
  def identifier; end
  ...
  # @see Identifier#key
  #
  # source://dry-system//lib/dry/system/indirect_component.rb#49
  def key; end
  ...
  # @return [FalseClass]
  #
  # source://dry-system//lib/dry/system/indirect_component.rb#38
  def loadable?; end
  ...
  # @see Identifier#root_key
  #
  # source://dry-system//lib/dry/system/indirect_component.rb#60
  def root_key; end
end

Dry::System::InvalidComponentError = Dry::System::ProviderNotFoundError

# source://dry-system//lib/dry/system/constants.rb#12
...
# @api public
#
# source://dry-system//lib/dry/system/errors.rb#31
class Dry::System::NamespaceAlreadyAddedError < ::StandardError
  # source://dry-system//lib/dry/system/errors.rb#32
...
class Dry::System::PluginDependencyMissing < ::StandardError
  # source://dry-system//lib/dry/system/errors.rb#90
...
# @api public
#
# source://dry-system//lib/dry/system/errors.rb#79
class Dry::System::PluginNotFoundError < ::StandardError
  # source://dry-system//lib/dry/system/errors.rb#80
  def initialize(plugin_name); end
end

# source://dry-system//lib/dry/system/plugins.rb#7
module Dry::System::Plugins
  # @api private
  #
  # source://dry-system//lib/dry/system/plugins.rb#113
  def enabled_plugins; end

  # @api private
  #
  # source://dry-system//lib/dry/system/plugins.rb#107
  def inherited(klass); end
  ...
  # @return [self]
  #
  # source://dry-system//lib/dry/system/plugins.rb#93
  def use(name, **options); end

  class << self
    # @api private
    #
    # source://dry-system//lib/dry/system/plugins.rb#80
    ...
    # @return [Plugins]
    #
    # source://dry-system//lib/dry/system/plugins.rb#70
    def register(name, plugin, &block); end

    # @api private
    #
    # source://dry-system//lib/dry/system/plugins.rb#75
    def registry; end
  end
end
...
# @api public
#
# source://dry-system//lib/dry/system/plugins/dependency_graph/strategies.rb#6
module Dry::System::Plugins::DependencyGraph
  # @api private
  #
  # source://dry-system//lib/dry/system/plugins/dependency_graph.rb#34
  def injector(**options); end

  # @api private
  #
  # source://dry-system//lib/dry/system/plugins/dependency_graph.rb#39
  def register(key, contents = T.unsafe(nil), options = T.unsafe(nil), &block); end

  class << self
    # @api private
    #
    # source://dry-system//lib/dry/system/plugins/dependency_graph.rb#29
    def dependencies; end

    # @api private
    # @private
    #
    # source://dry-system//lib/dry/system/plugins/dependency_graph.rb#11
    def extended(system); end
  end
end
...
# @api public
#
# source://dry-system//lib/dry/system/plugins/monitoring/proxy.rb#8
module Dry::System::Plugins::Monitoring
  # @api private
  #
  # source://dry-system//lib/dry/system/plugins/monitoring.rb#28
  def monitor(key, **options, &block); end

  class << self
    # @api private
    #
    # source://dry-system//lib/dry/system/plugins/monitoring.rb#23
    def dependencies; end

    # @api private
    # @private
    #
    # source://dry-system//lib/dry/system/plugins/monitoring.rb#12
    def extended(system); end
  end
end
...
# @api private
#
# source://dry-system//lib/dry/system/plugins.rb#9
class Dry::System::Plugins::Plugin
  # @api private
  # @return [Plugin] a new instance of Plugin
  #
  # source://dry-system//lib/dry/system/plugins.rb#17
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/plugins.rb#31
  def load_dependencies(dependencies = T.unsafe(nil), gem = T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system//lib/dry/system/plugins.rb#42
  def load_dependency(dependency, gem); end

  # @api private
  #
  # source://dry-system//lib/dry/system/plugins.rb#12
  def mod; end

  # @api private
  #
  # source://dry-system//lib/dry/system/plugins.rb#55
  def mod_dependencies; end

  # @api private
  #
  # source://dry-system//lib/dry/system/plugins.rb#10
  def name; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/plugins.rb#50
  def stateful?; end
end
...
#
# source://dry-system//lib/dry/system/provider/source_dsl.rb#7
class Dry::System::Provider
  # @api private
  # @return [Provider] a new instance of Provider
  #
  # source://dry-system//lib/dry/system/provider.rb#132
  ...
  #
  # source://dry-system//lib/dry/system/provider.rb#98
  def container; end
  ...
  # @return [Symbol]
  #
  # source://dry-system//lib/dry/system/provider.rb#62
  def name; end
  ...
  #
  # source://dry-system//lib/dry/system/provider.rb#69
  def namespace; end
  ...
  # @return [self]
  #
  # source://dry-system//lib/dry/system/provider.rb#156
  def prepare; end
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/provider.rb#189
  def prepared?; end
  ...
  #
  # source://dry-system//lib/dry/system/provider.rb#129
  def source; end
  ...
  # @return [self]
  #
  # source://dry-system//lib/dry/system/provider.rb#168
  def start; end
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/provider.rb#196
  def started?; end
  ...
  # @return [Array<Symbol>]
  #
  # source://dry-system//lib/dry/system/provider.rb#79
  def statuses; end
  ...
  # @return [self]
  #
  # source://dry-system//lib/dry/system/provider.rb#180
  def stop; end
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/provider.rb#203
  def stopped?; end
  ...
  #
  # source://dry-system//lib/dry/system/provider.rb#112
  def target; end
  ...
  # @return [self]
  #
  # source://dry-system//lib/dry/system/provider.rb#268
  def apply; end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider.rb#210
  def build_provider_container; end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider.rb#227
  ...
  # @return [Symbol, nil]
  #
  # source://dry-system//lib/dry/system/provider.rb#86
  ...
  # @see {#run_step}
  #
  # source://dry-system//lib/dry/system/provider.rb#257
  def step_running?; end
end
...
#
# source://dry-system//lib/dry/system/provider/source.rb#37
class Dry::System::Provider::Source
  ...
  #
  # source://dry-system//lib/dry/system/provider/source.rb#128
  ...
  # @see #before
  #
  # source://dry-system//lib/dry/system/provider/source.rb#248
  ...
  # @see #after
  #
  # source://dry-system//lib/dry/system/provider/source.rb#219
  def before(step_name, &block); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source.rb#92
  def callbacks; end
  ...
  #
  # source://dry-system//lib/dry/system/provider/source.rb#107
  def container; end
  ...
  # @return [String]
  #
  # source://dry-system//lib/dry/system/provider/source.rb#141
  def inspect; end
  ...
  #
  # source://dry-system//lib/dry/system/provider/source.rb#159
  def prepare; end
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source.rb#265
  ...
  # @see SourceDSL#start
  #
  # source://dry-system//lib/dry/system/provider/source.rb#174
  def start; end
  ...
  # @see SourceDSL#stop
  #
  # source://dry-system//lib/dry/system/provider/source.rb#189
  def stop; end
  ...
  # @see Dry::System::Provider
  #
  # source://dry-system//lib/dry/system/provider/source.rb#124
  def target; end
  ...
  # @api public
  #
  # source://dry-system//lib/dry/system/provider/source.rb#191
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source.rb#314
  def method_missing(name, *args, &block); end
  ...
  #
  # source://dry-system//lib/dry/system/provider/source.rb#292
  ...
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/provider/source.rb#323
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source.rb#308
  ...
  class << self
    ...
    #
    # source://dry-system//lib/dry/system/provider/source.rb#45
    def for(name:, target_container:, group: T.unsafe(nil), &block); end

    # @api public
    # @private
    #
    # source://dry-system//lib/dry/system/provider/source.rb#53
    ...
    # @api private
    #
    # source://dry-system//lib/dry/system/provider/source.rb#67
    def name; end
...
# @api public
#
# source://dry-system//lib/dry/system/provider/source.rb#85
...
# @see Dry::System::Container.register_provider
#
# source://dry-system//lib/dry/system/provider/source_dsl.rb#14
class Dry::System::Provider::SourceDSL
  ...
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#32
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#65
  def prepare(&block); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#36
  def setting(*_arg0, &_arg1); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#42
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#70
  def start(&block); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#74
  def stop(&block); end
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#80
  def method_missing(name, *args, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#88
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end
...
# @api private
#
# source://dry-system//lib/dry/system/provider/source_dsl.rb#55
class Dry::System::Provider::SourceDSL::DeprecatedSettingsDSL
  ...
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#56
  def initialize(base_dsl); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider/source_dsl.rb#60
...
# @api public
#
# source://dry-system//lib/dry/system/errors.rb#43
class Dry::System::ProviderAlreadyRegisteredError < ::ArgumentError
  # source://dry-system//lib/dry/system/errors.rb#44
...
class Dry::System::ProviderNotFoundError < ::ArgumentError
  # source://dry-system//lib/dry/system/errors.rb#55
...
class Dry::System::ProviderRegistrar
  ...
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#29
  def initialize(container); end
  ...
  # @api public
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#80
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#26
  def container; end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#146
  def finalize!; end
  ...
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#95
  def find_and_load_provider(name); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#35
  def freeze; end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#86
  def key?(provider_name); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#170
  ...
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#129
  def provider_files; end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#23
  def providers; end
  ...
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#44
  def register_provider(name, namespace: T.unsafe(nil), from: T.unsafe(nil), source: T.unsafe(nil), if: T.unsafe(nil), &block); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#164
  def shutdown; end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#176
  def start(provider_name); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#110
  def start_provider_dependency(component); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#182
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#220
  def build_provider(name, namespace:, source: T.unsafe(nil), &block); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#235
  def build_provider_from_source(name, source:, group:, namespace:, &block); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#271
  def find_provider_file(name); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#257
  def load_provider(path); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#191
  def provider_paths; end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#265
  ...
  # @yield [provider]
  #
  # source://dry-system//lib/dry/system/provider_registrar.rb#247
...
# @api public
#
# source://dry-system//lib/dry/system/errors.rb#65
class Dry::System::ProviderSourceNotFoundError < ::StandardError
  # source://dry-system//lib/dry/system/errors.rb#66
  def initialize(name:, group:, keys:); end
end

# @api private
#
# source://dry-system//lib/dry/system/provider_source_registry.rb#10
class Dry::System::ProviderSourceRegistry
  # @api private
  # @return [ProviderSourceRegistry] a new instance of ProviderSourceRegistry
  #
  # source://dry-system//lib/dry/system/provider_source_registry.rb#13
  def initialize; end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_source_registry.rb#17
  def load_sources(path); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_source_registry.rb#23
  def register(name:, group:, source:); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_source_registry.rb#27
  def register_from_block(name:, group:, target_container:, &block); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_source_registry.rb#40
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider_source_registry.rb#65
...
# @api private
#
# source://dry-system//lib/dry/system/provider_sources/settings/config.rb#32
class Dry::System::ProviderSources::Settings::Config
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider_sources/settings/config.rb#71
  def method_missing(name, *args, &block); end

  # @api private
  # @return [Boolean]
  #
  # source://dry-system//lib/dry/system/provider_sources/settings/config.rb#79
  def respond_to_missing?(name, include_all = T.unsafe(nil)); end

  class << self
    # @api private
    #
    # source://dry-system//lib/dry/system/provider_sources/settings/config.rb#55
    def key(name, type); end

    # @api private
    #
    # source://dry-system//lib/dry/system/provider_sources/settings/config.rb#34
...
# @api private
#
# source://dry-system//lib/dry/system/provider_sources/settings/config.rb#12
class Dry::System::ProviderSources::Settings::InvalidSettingsError < ::ArgumentError
  # source://dry-system//lib/dry/system/provider_sources/settings/config.rb#14
  def initialize(errors); end

  private

  # source://dry-system//lib/dry/system/provider_sources/settings/config.rb#26
  def setting_errors(errors); end
end

# @api private
#
# source://dry-system//lib/dry/system/provider_sources/settings/loader.rb#11
class Dry::System::ProviderSources::Settings::Loader
  # @api private
  # @return [Loader] a new instance of Loader
  #
  # source://dry-system//lib/dry/system/provider_sources/settings/loader.rb#16
  def initialize(root:, env:, store: T.unsafe(nil)); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_sources/settings/loader.rb#22
  def [](key); end
  ...
  # @api private
  #
  # source://dry-system//lib/dry/system/provider_sources/settings/loader.rb#41
  def dotenv_files(root, env); end

  # @api private
  #
  # source://dry-system//lib/dry/system/provider_sources/settings/loader.rb#28
...
# source://dry-system//lib/dry/system/constants.rb#13
