...
class ActiveRecord::Base
  ...
  # source://activerecord/7.0.5.1/lib/active_record/reflection.rb#11
  ...
  # source://activemodel/7.0.5.1/lib/active_model/validations.rb#52
  def _validators; end

  # source://activemodel/7.0.5.1/lib/active_model/validations.rb#52
  def _validators?; end

  # source://activerecord/7.0.5.1/lib/active_record/reflection.rb#12
  ...
  # source://activemodel/7.0.5.1/lib/active_model/attribute_methods.rb#72
  def attribute_aliases; end

  # source://activemodel/7.0.5.1/lib/active_model/attribute_methods.rb#72
  def attribute_aliases?; end

  # source://activemodel/7.0.5.1/lib/active_model/attribute_methods.rb#73
  def attribute_method_matchers; end

  # source://activemodel/7.0.5.1/lib/active_model/attribute_methods.rb#73
  def attribute_method_matchers?; end

  # source://activerecord/7.0.5.1/lib/active_record/reflection.rb#13
  def automatic_scope_inversing; end

  # source://activerecord/7.0.5.1/lib/active_record/reflection.rb#13
  def automatic_scope_inversing?; end

  # source://activerecord/7.0.5.1/lib/active_record/integration.rb#16
  def cache_timestamp_format; end

  # source://activerecord/7.0.5.1/lib/active_record/integration.rb#16
  def cache_timestamp_format?; end

  # source://activerecord/7.0.5.1/lib/active_record/integration.rb#24
  def cache_versioning; end

  # source://activerecord/7.0.5.1/lib/active_record/integration.rb#24
  def cache_versioning?; end

  # source://activerecord/7.0.5.1/lib/active_record/integration.rb#32
  def collection_cache_versioning; end

  # source://activerecord/7.0.5.1/lib/active_record/integration.rb#32
  def collection_cache_versioning?; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#171
  def column_for_attribute(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#74
  def default_connection_handler; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#74
  def default_connection_handler?; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#76
  def default_role; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#76
  def default_role?; end

  # source://activerecord/7.0.5.1/lib/active_record/scoping/default.rb#20
  def default_scope_override; end

  # source://activerecord/7.0.5.1/lib/active_record/scoping/default.rb#19
  def default_scopes; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#78
  def default_shard; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#78
  def default_shard?; end

  # source://activerecord/7.0.5.1/lib/active_record/enum.rb#116
  def defined_enums; end

  # source://activerecord/7.0.5.1/lib/active_record/enum.rb#116
  def defined_enums?; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#26
  def destroy_association_async_job; end

  # source://activerecord/7.0.5.1/lib/active_record/encryption/encryptable_record.rb#11
  ...
  # source://activemodel/7.0.5.1/lib/active_model/serializers/json.rb#15
  def include_root_in_json; end

  # source://activemodel/7.0.5.1/lib/active_model/serializers/json.rb#15
  def include_root_in_json?; end

  # source://activerecord/7.0.5.1/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically; end

  # source://activerecord/7.0.5.1/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically?; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#20
  def logger; end

  # source://activerecord/7.0.5.1/lib/active_record/core.rb#20
  def logger?; end

  # source://activemodel/7.0.5.1/lib/active_model/naming.rb#244
  def model_name(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.5.1/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options; end

  # source://activerecord/7.0.5.1/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options?; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/dirty.rb#18
  def partial_inserts; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/dirty.rb#18
  def partial_inserts?; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/dirty.rb#17
  def partial_updates; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/dirty.rb#17
  def partial_updates?; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#156
  def pluralize_table_names; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#156
  def pluralize_table_names?; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#151
  def primary_key_prefix_type; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#151
  def primary_key_prefix_type?; end

  # source://activerecord/7.0.5.1/lib/active_record/timestamp.rb#47
  ...
  # source://activerecord/7.0.5.1/lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret; end

  # source://activerecord/7.0.5.1/lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret?; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/time_zone_conversion.rb#67
  def skip_time_zone_conversion_for_attributes; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/time_zone_conversion.rb#67
  def skip_time_zone_conversion_for_attributes?; end

  # source://activerecord/7.0.5.1/lib/active_record/inheritance.rb#42
  def store_full_class_name; end

  # source://activerecord/7.0.5.1/lib/active_record/inheritance.rb#42
  def store_full_class_name?; end

  # source://activerecord/7.0.5.1/lib/active_record/inheritance.rb#46
  ...
  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#152
  def table_name_prefix; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#152
  def table_name_prefix?; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#153
  def table_name_suffix; end

  # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#153
  def table_name_suffix?; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/time_zone_conversion.rb#66
  def time_zone_aware_attributes; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/time_zone_conversion.rb#66
  def time_zone_aware_attributes?; end

  # source://activerecord/7.0.5.1/lib/active_record/attribute_methods/time_zone_conversion.rb#68
  ...
  # source://activemodel/7.0.5.1/lib/active_model/validations.rb#48
  ...
  class << self
    ...
    # source://activerecord/7.0.5.1/lib/active_record/readonly_attributes.rb#8
    ...
    # source://activemodel/7.0.5.1/lib/active_model/callbacks.rb#144
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#82
    def application_record_class?; end

    # source://activemodel/7.0.5.1/lib/active_model/callbacks.rb#137
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#129
    def asynchronous_queries_session; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#133
    ...
    # source://activerecord/7.0.5.1/lib/active_record/attributes.rb#11
    ...
    # source://activemodel/7.0.5.1/lib/active_model/callbacks.rb#130
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#68
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#56
    def configurations; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#50
    def configurations=(config); end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#201
    def connected_to_stack; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#215
    def connection_class; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#211
    def connection_class=(b); end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#219
    def connection_class?; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#223
    def connection_class_for_self; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#94
    def connection_handler; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#98
    def connection_handler=(handler); end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#102
    def connection_handlers; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#111
    def connection_handlers=(handlers); end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#188
    def current_preventing_writes; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#147
    def current_role; end

    # source://activerecord/7.0.5.1/lib/active_record/core.rb#169
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#66
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#72
    ...
    # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#158
    ...
    # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#157
    ...
    # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#160
    def inheritance_column; end

    # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#311
    def inheritance_column=(value); end

    # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#160
    def inheritance_column?; end

    # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#155
    ...
    # source://activerecord/7.0.5.1/lib/active_record/store.rb#99
    ...
    # source://activerecord/7.0.5.1/lib/active_record/model_schema.rb#154
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#80
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#70
    ...
    # source://activerecord/7.0.5.1/lib/active_record/core.rb#238
...
module ActiveStorage
  ...
  class << self
    ...
    # source://railties/7.0.5.1/lib/rails/engine.rb#405
    def railtie_helpers_paths; end

    # source://railties/7.0.5.1/lib/rails/engine.rb#394
    def railtie_namespace; end

    # source://railties/7.0.5.1/lib/rails/engine.rb#409
    ...
    # source://railties/7.0.5.1/lib/rails/engine.rb#397
    def table_name_prefix; end
    ...
    # source://railties/7.0.5.1/lib/rails/engine.rb#401
...
class ActiveStorage::AnalyzeJob < ::ActiveStorage::BaseJob
  ...
  class << self
    # source://activejob/7.0.5.1/lib/active_job/queue_name.rb#56
    def queue_name; end

    # source://activesupport/7.0.5.1/lib/active_support/rescuable.rb#13
...
class ActiveStorage::Attached::Many < ::ActiveStorage::Attached
  ...
  # source://activesupport/7.0.5.1/lib/active_support/core_ext/module/delegation.rb#302
  ...
  # source://activesupport/7.0.5.1/lib/active_support/core_ext/module/delegation.rb#294
...
class ActiveStorage::Attachment < ::ActiveStorage::Record
  ...
  # source://activerecord/7.0.5.1/lib/active_record/autosave_association.rb#160
  ...
  class << self
    ...
    # source://activerecord/7.0.5.1/lib/active_record/scoping/named.rb#174
    def with_all_variant_records(*args, **_arg1); end
  end
end

module ActiveStorage::Attachment::GeneratedAssociationMethods
  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/association.rb#103
  def blob; end

  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/association.rb#111
  def blob=(value); end

  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/belongs_to.rb#132
  def blob_changed?; end

  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/belongs_to.rb#136
  def blob_previously_changed?; end

  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/singular_association.rb#28
  def build_blob(*args, &block); end

  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/singular_association.rb#32
  def create_blob(*args, &block); end

  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/singular_association.rb#36
  def create_blob!(*args, &block); end
  ...
  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/singular_association.rb#19
  def reload_blob; end
...
class ActiveStorage::BaseController < ::ActionController::Base
  ...
  class << self
    ...
    # source://actionpack/7.0.5.1/lib/action_controller/metal/etag_with_template_digest.rb#27
...
class ActiveStorage::Blob < ::ActiveStorage::Record
  ...
  # source://actiontext/7.0.5.1/lib/action_text/engine.rb#43
  ...
  # source://actiontext/7.0.5.1/lib/action_text/engine.rb#39
  def previewable_attachable?; end

  def purge; end
  def purge_later; end

  # source://activerecord/7.0.5.1/lib/active_record/secure_token.rb#39
  ...
  # source://actiontext/7.0.5.1/lib/action_text/engine.rb#47
...
module ActiveStorage::Blob::GeneratedAssociationMethods
  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/collection_association.rb#62
  def attachment_ids; end

  # source://activerecord/7.0.5.1/lib/active_record/associations/builder/collection_association.rb#72
...
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  ...
  class << self
    # source://activesupport/7.0.5.1/lib/active_support/current_attributes.rb#118
    def url_options; end
...
class ActiveStorage::FixtureSet
  ...
  # source://activesupport/7.0.5.1/lib/active_support/testing/file_fixtures.rb#20
