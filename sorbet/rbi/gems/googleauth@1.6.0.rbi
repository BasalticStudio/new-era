...
module Google::Auth::CredentialsLoader
  ...
  #
  # source://googleauth//lib/googleauth/credentials_loader.rb#81
  ...
  #   * `:connection_builder` A `Proc` that returns a connection.
  #
  # source://googleauth//lib/googleauth/credentials_loader.rb#133
  ...
  #   * `:connection_builder` A `Proc` that returns a connection.
  #
  # source://googleauth//lib/googleauth/credentials_loader.rb#107
  ...
  #
  # source://googleauth//lib/googleauth/credentials_loader.rb#63
  def make_creds(*args); end

  private

  # source://googleauth//lib/googleauth/credentials_loader.rb#185
  def authorized_user_env_vars?; end

  # source://googleauth//lib/googleauth/credentials_loader.rb#171
  def interpret_options(scope, options); end

  # Finds project_id from gcloud CLI configuration
  #
  # source://googleauth//lib/googleauth/credentials_loader.rb#159
  ...
  #
  # source://googleauth//lib/googleauth/credentials_loader.rb#153
...
# source://googleauth//lib/googleauth/credentials_loader.rb#52
...
class Google::Auth::DefaultCredentials
  ...
  class << self
    ...
    #
    # source://googleauth//lib/googleauth/default_credentials.rb#65
    ...
    # source://googleauth//lib/googleauth/default_credentials.rb#48
    def read_creds; end
  end
end
...
#
# source://googleauth//lib/googleauth/external_account.rb#29
class Google::Auth::ExternalAccount::Credentials
  class << self
    ...
    #
    # source://googleauth//lib/googleauth/external_account.rb#54
    def read_json_key(json_key_io); end

    private

    # source://googleauth//lib/googleauth/external_account.rb#68
    def make_aws_credentials(user_creds, scope); end

    # @raise [INVALID_EXTERNAL_ACCOUNT_TYPE]
    #
    # source://googleauth//lib/googleauth/external_account.rb#79
