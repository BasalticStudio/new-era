  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::AdminUser).void)
      ).returns(T.nilable(T::Enumerator[::AdminUser]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::AdminUser]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::AdminUser]]))
    end
