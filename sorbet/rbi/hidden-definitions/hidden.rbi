...
module Bankai
  CAPISTRANO_VERSION = ::T.let(nil, ::T.untyped)
  RAILS_VERSION = ::T.let(nil, ::T.untyped)
  RUBOCOP_VERSION = ::T.let(nil, ::T.untyped)
  RUBY_VERSION = ::T.let(nil, ::T.untyped)
  VERSION = ::T.let(nil, ::T.untyped)
end

module Bankai::Generators
  HOST_TEMPLATE = ::T.let(nil, ::T.untyped)
end

class Bankai::Generators::DeployGenerator
  DEFAULT_REPO = ::T.let(nil, ::T.untyped)
end
